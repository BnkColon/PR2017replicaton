...
Defining viability as the percentage of cells that survive upon exposure to a certain drug, the range of survival should be between 0% and 100%- asuming no additional growth happens. The data points contained in (0,100) would be 27,626 observations out of a sample of 43427. Notwithstanding, many outliers were found, totaling a number of 15,801 observations, that make up aproximately 36.39% of the total sample. This large number of outliers could be related to many factors such as: the organism's tolerance of the pharmacological agents, faulty pharmacological agents, human error, measurement error, and other environmental interactions occurring in the pietry dish.  
